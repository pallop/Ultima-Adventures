	...
	public class Lumberjacking : HarvestSystem
	{
		...
		public Lumberjacking()
		{
			...
			lumber.BonusResources = new BonusHarvestResource[]
			{
				...
				//new BonusHarvestResource( 100, 10.0, "pulimento de madera", typeof( OilWood ) ),
				new BonusHarvestResource( 100, 03.0, "aceite de segador", typeof( ReaperOil ) ),
				new BonusHarvestResource( 100, 02.0, "savia de árbol místico", typeof( MysticalTreeSap ) ),
				new BonusHarvestResource( 100, 01.0, "champiñones", typeof( HomePlants_Mushroom ) )
			};
